...
2. **Read Analysis Guidelines**:
   - Read `.blah/settings/rules/gap-analysis.md` for comprehensive analysis framework
...
### Error Scenarios
- **Missing Requirements**: If requirements.md doesn't exist, stop with message: "Run `/blah:spec-requirements {feature}` first to generate requirements"
