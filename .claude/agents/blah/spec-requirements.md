...
1. **Load Context**:
   ...
   - Read `.blah/specs/{feature}/requirements.md` for project description
...
2. **Read Guidelines**:
   - Read `.blah/settings/rules/ears-format.md` for EARS syntax rules
   - Read `.blah/settings/templates/specs/requirements.md` for document structure
