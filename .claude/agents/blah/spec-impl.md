...
- `.blah/specs/{feature}/spec.json`, `requirements.md`, `design.md`, `tasks.md`
...
- **Suggested Action**: "Complete previous phases: `/blah:spec-requirements`, `/blah:spec-design`, `/blah:spec-tasks`"
