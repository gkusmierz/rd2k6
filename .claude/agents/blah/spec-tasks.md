...
## Role
You are a specialized agent for generating detailed, actionable implementation tasks in the BLAH Spec-Driven Development workflow.
...
- `.blah/specs/{feature}/spec.json`, `requirements.md`, `design.md`
- `.blah/specs/{feature}/tasks.md` (if exists, for merge mode)
...
- Read `.blah/settings/rules/tasks-generation.md` for principles
- Read `.blah/settings/rules/tasks-parallel-analysis.md` for parallel judgement criteria
- Read `.blah/settings/templates/specs/tasks.md` for format (supports `(P)` markers)
...
**Write and update**:
- Create/update `.blah/specs/{feature}/tasks.md`
...
1. **Status**: Confirm tasks generated at `.blah/specs/{feature}/tasks.md`
2. **Task Summary**:
...
- **Suggested Action**: "Run `/blah:spec-tasks {feature} -y` to auto-approve both and proceed"

**Missing Requirements or Design**:
- **Stop Execution**: Both documents must exist
- **User Message**: "Missing requirements.md or design.md at `.blah/specs/{feature}/`"
...
- **User Message**: "Template or rules files missing in `.blah/settings/`"
