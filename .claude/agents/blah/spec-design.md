...
- Glob(`.blah/steering/*.md`) to get all steering files
...
- `.blah/specs/{feature}/spec.json`, `requirements.md`, `design.md` (if exists)
- **Entire `.blah/steering/` directory** for complete project memory
- `.blah/settings/templates/specs/design.md` for document structure
- `.blah/settings/rules/design-principles.md` for design principles
...
2. **Execute Appropriate Discovery Process**:
   ...
   **For Complex/New Features**:
   - Read and execute `.blah/settings/rules/design-discovery-full.md`
   ...
   **For Extensions**:
   - Read and execute `.blah/settings/rules/design-discovery-light.md`
...
1. **Load Design Template and Rules**:
   - Read `.blah/settings/templates/specs/design.md` for structure
   - Read `.blah/settings/rules/design-principles.md` for principles
...
1. **Status**: Confirm design document generated at `.blah/specs/{feature}/design.md`
...
**Note**: The actual design document follows `.blah/settings/templates/specs/design.md` structure.
...
- **Suggested Action**: "Run `/blah:spec-design {feature} -y` to auto-approve requirements and proceed"

**Missing Requirements**:
- **Stop Execution**: Requirements document must exist
- **User Message**: "No requirements.md found at `.blah/specs/{feature}/requirements.md`"
- **Suggested Action**: "Run `/blah:spec-requirements {feature}` to generate requirements first"

**Template Missing**:
- **User Message**: "Template file missing at `.blah/settings/templates/specs/design.md`"
...
- **Default**: Use full discovery process (`.blah/settings/rules/design-discovery-full.md`)
