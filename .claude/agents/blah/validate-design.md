...
1. **Load Context**:
   - Read `.blah/specs/{feature}/spec.json` for language and metadata
   - Read `.blah/specs/{feature}/requirements.md` for requirements
   - Read `.blah/specs/{feature}/design.md` for design document
...
2. **Read Review Guidelines**:
   - Read `.blah/settings/rules/design-review.md` for review criteria and process
...
### Error Scenarios
- **Missing Design**: If design.md doesn't exist, stop with message: "Run `/blah:spec-design {feature}` first to generate design document"
