...
- .blah/settings/templates/steering-custom/*.md
...
Available templates in `.blah/settings/templates/steering-custom/`:
...
- `.blah/settings/` content should NOT be documented (it's metadata, not project knowledge)
