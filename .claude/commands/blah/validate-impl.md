...
- Parse conversation history for `/blah:spec-impl <feature> [tasks]` patterns
- OR scan `.blah/specs/*/tasks.md` for `[x]` checkboxes
- Pass detected features and tasks to Subagent

**If feature only** (`$1` present, `$2` empty):
- Read `.blah/specs/$1/tasks.md` and find all `[x]` checkboxes
...
- Re-run `/blah:spec-impl <feature> [tasks]` for fixes
- Re-validate with `/blah:validate-impl [feature] [tasks]`
