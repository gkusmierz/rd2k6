...
- Verify `.blah/specs/$1/tasks.md` exists
...
- Otherwise: Read `.blah/specs/$1/tasks.md` and find all unchecked tasks (`- [ ]`)
...
- `/blah:spec-impl $1 1.1` - Single task
- `/blah:spec-impl $1 1,2,3` - Multiple tasks

**Execute all pending**:
- `/blah:spec-impl $1` - All unchecked tasks
